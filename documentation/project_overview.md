...
Generated on: Tue Sep 24 12:19:08 CDT 2024
...
- [./project_overview.md](#file---project-overview-md)
...
## File: ./project_overview.md {#file---project-overview-md}
...
<body class="dark-theme">
        ...
        <main>
            ...
            <div id="chart-container">
                <div id="timeframe-selector">
                    ...
                    <button class="timeframe-btn" data-timeframe="W">1W</button>
                    <button class="timeframe-btn" data-timeframe="M">1M</button>
                    <button id="indicators-button" class="timeframe-btn"><i class="fas fa-chart-line"></i> Indicators</button>
                </div>
                <div id="symbol-info"></div>
                <div id="candlestick-chart"></div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="indicator-categories">
                    ...
                    <button class="category-btn" data-category="technicals">Technicals</button>
                </div>
    ...
    <script src="{{ url_for('static', filename='js/chart.js') }}"></script>
    <script type="module" src="{{ url_for('static', filename='js/indicators.js') }}"></script>
